package com.helpdesk.model.services.manager;
...
public class PropertyManager {
	...
	public static void loadProperties(String propertyFileLocation)
		...
		try {
			...
			System.out
					.println("Property file successfully loaded from location: "
	 ...
	 * 
	 * @param key
	 *            - key whose value needs to be returned
